...
export const CLUSTERS: Cluster[] = [
  { id: "ai", label: "AI / GenAI", color: "#8b7dff", dir: u([0.82, 0.44, 0.22]), proof: "Shipped a RAG docs assistant and AI code-review tooling at Temenos; OpenAI powers Trip Captain; my Settle MCP server runs live in Claude and ChatGPT.", skills: ["LangChain", "LangGraph", "RAG", "Embeddings", "OpenAI API", "MCP", "Vector Search"] },
  ...
  { id: "be", label: "Backend / Data", color: "#4ade80", dir: u([0.6, -0.66, -0.18]), proof: "The APIs and Supabase data layer behind five live products.", skills: ["Node.js", "Supabase", "Edge Functions", "OAuth", "REST", "SQL"] },
